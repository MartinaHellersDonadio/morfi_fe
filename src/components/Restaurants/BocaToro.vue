  ...
  <div>
    ...
    <div class="img-container">
      <div class="subcontainer">
        <img class="image-resto" src="../../assets/img/products/boca_toro.jpg" alt="bondi menu">
      </div>

      <div class="subcontainer">
        <img class="image-resto" src="../../assets/img/products/boca_toro2.jpg" alt="bondi location">
      </div>

      <div class="subcontainer">
        <img class="image-resto" src="../../assets/img/products/boca_toro3.jpg" alt="bondi menu">
      </div>
    </div>
