  ...
  <div>
    ...
    <div class="img-container">
      <div class="subcontainer">
        <img class="image-resto" src="../../assets/img/products/bondi_img.jpg" alt="bondi menu">
      </div>

      <div class="subcontainer">
        <img class="image-resto" src="../../assets/img/products/bondi_2.jpg" alt="bondi location">
      </div>

      <div class="subcontainer">
        <img class="image-resto" src="../../assets/img/products/bondi_3.jpg" alt="bondi menu">
      </div>
    </div>
    ...
    <div class="details-container">
      <div class="details-subcontainer">
        ...
        <img class="qr-image" src="../../assets/img/products/qr_bondi.png" alt="menu qr bondi stop">
      </div>
...
export default {
  ...
  mounted() {
    ...
    axios.get('http://localhost:5000/api/v1/reviews/' + this.bondirestaurant["shop_id"])
        .then(response => {
