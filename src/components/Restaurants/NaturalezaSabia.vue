  ...
  <div>
    ...
    <div class="img-container">
      <div class="subcontainer">
        <img class="image-resto" src="../../assets/img/products/naturaleza_sabia.jpg" alt="bondi menu">
      </div>

      <div class="subcontainer">
        <img class="image-resto" src="../../assets/img/products/naturaleza_sabia2.jpg" alt="bondi location">
      </div>

      <div class="subcontainer">
        <img class="image-resto" src="../../assets/img/products/naturaleza_sabia3.jpg" alt="bondi menu">
      </div>
    </div>
